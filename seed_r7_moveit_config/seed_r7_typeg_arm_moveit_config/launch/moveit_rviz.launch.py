"""
moveit_rviz.launch.py  —  RViz2 with MoveIt2 MotionPlanning plugin for SEED-Arm-Mover-typeG
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_share = get_package_share_directory('seed_r7_typeg_arm_moveit_config')
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            'SEED-Arm-Mover-typeG',
            package_name='seed_r7_typeg_arm_moveit_config',
        )
        .robot_description(file_path=xacro_file, mappings=xacro_mappings)
        .robot_description_semantic(file_path='config/SEED-Arm-Mover-typeG.srdf')
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('robot_model',     default_value='typeg_arm'),
